...
public class Usuario implements UserDetails {
	...
	"acesso_id" }, name = "unique_acesso_user"), joinColumns = @JoinColumn(name = "usuario_id", referencedColumnName = "id", 
	...
	/* Permissões (ROLE_ADMIN, ROLE_SECRETARIO_ ROLE_FINANCEIRO) */
	@Override
