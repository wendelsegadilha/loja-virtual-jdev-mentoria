...
-- Started on 2022-08-07 11:35:28
...
--
-- TOC entry 2342 (class 1262 OID 16401)
...
--
-- TOC entry 221 (class 1255 OID 16661)
...
--
-- TOC entry 222 (class 1255 OID 16667)
...
CREATE TABLE imagem_produto (
    id bigint NOT NULL,
    imagem_minhatura text NOT NULL,
...
--
-- TOC entry 208 (class 1259 OID 16554)
...
--
-- TOC entry 211 (class 1259 OID 16560)
...
--
-- TOC entry 198 (class 1259 OID 16514)
...
--
-- TOC entry 2298 (class 0 OID 16402)
-- Dependencies: 181
...
--
-- TOC entry 2299 (class 0 OID 16407)
-- Dependencies: 182
-- Data for Name: avaliacao_produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO avaliacao_produto (id, descricao, nota, pessoa_id, produto_id) VALUES (2, 'teste avaliacao produto trigger', 10, 1, 1);


--
-- TOC entry 2300 (class 0 OID 16412)
-- Dependencies: 183
...
--
-- TOC entry 2301 (class 0 OID 16417)
-- Dependencies: 184
...
--
-- TOC entry 2303 (class 0 OID 16433)
-- Dependencies: 186
...
--
-- TOC entry 2304 (class 0 OID 16438)
-- Dependencies: 187
...
--
-- TOC entry 2305 (class 0 OID 16446)
-- Dependencies: 188
...
--
-- TOC entry 2306 (class 0 OID 16451)
-- Dependencies: 189
...
--
-- TOC entry 2307 (class 0 OID 16459)
-- Dependencies: 190
...
--
-- TOC entry 2308 (class 0 OID 16464)
-- Dependencies: 191
...
--
-- TOC entry 2309 (class 0 OID 16469)
-- Dependencies: 192
...
--
-- TOC entry 2310 (class 0 OID 16477)
-- Dependencies: 193
...
--
-- TOC entry 2311 (class 0 OID 16485)
-- Dependencies: 194
...
--
-- TOC entry 2312 (class 0 OID 16490)
-- Dependencies: 195
-- Data for Name: pessoa_fisica; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO pessoa_fisica (id, email, nome, telefone, cpf, data_nascimento) VALUES (1, 'pessoa1@gmail.com', 'Pessoa 1', '98965874125', '65897412589', '1995-05-14');


--
-- TOC entry 2313 (class 0 OID 16498)
-- Dependencies: 196
...
--
-- TOC entry 2314 (class 0 OID 16506)
-- Dependencies: 197
-- Data for Name: produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO produto (id, alerta_qtde_estoque, altura, ativo, descricao, largura, link_youtube, nome, peso, qtd_estoque, qtde_alerta_estoque, qtde_clique, tipo_unidade, valor_venda) VALUES (1, true, 1.5, true, 'camisa manga longa', 5.4000000000000004, 'link do video', 'camisa de manga longa', 0.65000000000000002, 5, 2, 10, 'und', 45.50);
...
--
-- TOC entry 2315 (class 0 OID 16514)
-- Dependencies: 198
...
--
-- TOC entry 2316 (class 0 OID 16522)
-- Dependencies: 199
...
--
-- TOC entry 2317 (class 0 OID 16530)
-- Dependencies: 200
...
--
-- TOC entry 2318 (class 0 OID 16533)
-- Dependencies: 201
...
--
-- TOC entry 2113 (class 2606 OID 16411)
...
--
-- TOC entry 2115 (class 2606 OID 16416)
...
--
-- TOC entry 2117 (class 2606 OID 16424)
...
--
-- TOC entry 2119 (class 2606 OID 16432)
...
--
-- TOC entry 2123 (class 2606 OID 16445)
...
--
-- TOC entry 2125 (class 2606 OID 16450)
...
--
-- TOC entry 2129 (class 2606 OID 16463)
...
--
-- TOC entry 2131 (class 2606 OID 16468)
...
--
-- TOC entry 2133 (class 2606 OID 16476)
...
--
-- TOC entry 2135 (class 2606 OID 16484)
...
--
-- TOC entry 2137 (class 2606 OID 16489)
...
--
-- TOC entry 2139 (class 2606 OID 16497)
...
--
-- TOC entry 2141 (class 2606 OID 16505)
...
--
-- TOC entry 2145 (class 2606 OID 16521)
...
--
-- TOC entry 2149 (class 2606 OID 16541)
...
--
-- TOC entry 2147 (class 2606 OID 16529)
...
--
-- TOC entry 2151 (class 2606 OID 16537)
...
--
-- TOC entry 2168 (class 2620 OID 16662)
...
--
-- TOC entry 2169 (class 2620 OID 16664)
...
--
-- TOC entry 2170 (class 2620 OID 16665)
...
--
-- TOC entry 2171 (class 2620 OID 16666)
...
--
-- TOC entry 2174 (class 2620 OID 16670)
...
--
-- TOC entry 2175 (class 2620 OID 16671)
...
--
-- TOC entry 2176 (class 2620 OID 16672)
-- Name: validachavepessoaendereco; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoaendereco BEFORE UPDATE ON endereco FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2177 (class 2620 OID 16673)
-- Name: validachavepessoaendereco2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoaendereco2 BEFORE INSERT ON endereco FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2172 (class 2620 OID 16668)
-- Name: validachavepessoaforncontapagar; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoaforncontapagar BEFORE UPDATE ON conta_pagar FOR EACH ROW EXECUTE PROCEDURE validachavepessoafornecedor();


--
-- TOC entry 2173 (class 2620 OID 16669)
-- Name: validachavepessoaforncontapagar2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoaforncontapagar2 BEFORE INSERT ON conta_pagar FOR EACH ROW EXECUTE PROCEDURE validachavepessoafornecedor();


--
-- TOC entry 2178 (class 2620 OID 16674)
-- Name: validachavepessoanotafiscalcompra; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoanotafiscalcompra BEFORE UPDATE ON nota_fiscal_compra FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2179 (class 2620 OID 16675)
-- Name: validachavepessoanotafiscalcompra2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoanotafiscalcompra2 BEFORE INSERT ON nota_fiscal_compra FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2180 (class 2620 OID 16676)
-- Name: validachavepessoausuario; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoausuario BEFORE UPDATE ON usuario FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2181 (class 2620 OID 16677)
-- Name: validachavepessoausuario2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoausuario2 BEFORE INSERT ON usuario FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2182 (class 2620 OID 16678)
-- Name: validachavepessoavdcplojavirt; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoavdcplojavirt BEFORE UPDATE ON vd_cp_loja_virt FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2183 (class 2620 OID 16679)
-- Name: validachavepessoavdcplojavirt2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoavdcplojavirt2 BEFORE INSERT ON vd_cp_loja_virt FOR EACH ROW EXECUTE PROCEDURE validachavepessoa();


--
-- TOC entry 2161 (class 2606 OID 16625)
...
--
-- TOC entry 2156 (class 2606 OID 16600)
...
--
-- TOC entry 2163 (class 2606 OID 16635)
...
--
-- TOC entry 2164 (class 2606 OID 16640)
...
--
-- TOC entry 2165 (class 2606 OID 16645)
...
ALTER TABLE ONLY nota_item_produto
    ADD CONSTRAINT nota_fiscal_compra_fk FOREIGN KEY (nota_fiscal_compra_id) REFERENCES produto(id);


--
-- TOC entry 2167 (class 2606 OID 16655)
...
--
-- TOC entry 2152 (class 2606 OID 16580)
...
--
-- TOC entry 2154 (class 2606 OID 16590)
-- Name: produto_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2159 (class 2606 OID 16615)
-- Name: produto_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2162 (class 2606 OID 16630)
...
--
-- TOC entry 2155 (class 2606 OID 16595)
-- Name: venda_compra_loja_virtual_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY item_venda_loja
    ADD CONSTRAINT venda_compra_loja_virtual_id FOREIGN KEY (venda_compra_loja_virtual_id) REFERENCES vd_cp_loja_virt(id);


--
-- TOC entry 2157 (class 2606 OID 16605)
-- Name: venda_compra_loja_virtual_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2160 (class 2606 OID 16620)
-- Name: venda_compra_loja_virtual_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2022-08-07 11:35:29
